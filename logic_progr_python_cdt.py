...
def configurar_sistema():
    ...
    if not os.path.exists("uploads_projects"):
        ...
        os.makedirs("uploads_projects")

def listar_projetos():
    
    """Lista todos os arquivos JSON na pasta de uploads."""
    
    arquivos = [f for f in os.listdir("uploads_projects") if f.endswith(".json")]
...
def fazer_upload_json():
    ...
    caminho = f"uploads_projects/projeto_{nome_fich}.json"
...
def gerenciar_projeto():
    ...
    try:
        ...
        caminho = f"uploads_projects/{nome_arquivo}"
